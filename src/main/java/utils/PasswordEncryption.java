...
public class PasswordEncryption {
	...
	/*public static void main(String[] args) {
		// TODO Auto-generated method stub
			...
			String strToEncode = "Shyam@1166";
	        String key = "Siri4ever";
	        //String strEncryptedString = "PwcaCjguXV5VXQ==";//PasswordEncryption.encryptXOR(strToEncode, key);
	        String strEncryptedString = PasswordEncryption.encryptXOR(strToEncode, key);
	        System.out.println("Encrypted string: " + strEncryptedString);
	        String decodedPwd = PasswordEncryption.decryptXOR(strEncryptedString, key);
